...
// --- CRITICAL: Define BOUNDARY constant here to match CSS ---
// This is essential for the scaling logic in drawDesign.
// It must match the values used in CSS for the .design-layer positioning.
const BOUNDARY = {
    TOP: 101,    // Matches var(--boundary-top)
    LEFT: 125,   // Matches var(--boundary-left)
    WIDTH: 150,  // Matches var(--boundary-width)
    HEIGHT: 150  // Matches var(--boundary-height)
};
console.log("BOUNDARY constant defined:", BOUNDARY);
...
function drawDesign(ctx, baseImage, designLayer) {
    // 1. Draw the base image first (already done, but good practice)
    ctx.drawImage(baseImage, 0, 0);
    ...
    //    This is defined in CSS and replicated here.
    // const BOUNDARY = { TOP: 101, LEFT: 125, WIDTH: 150, HEIGHT: 150 }; // Defined globally now
